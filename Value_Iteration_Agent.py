...
class Value_Iteration_Agent():
    ...
    def __init__(self, n_s, n_a, n_rows, n_cols, gamma, env):
        ...
        # Initializes estimated Value function (updated by value iteration algorithm)
        self.V = [0.0]*self.n_s
        
        # Initializes estimated Quality function (updated by value iteration algorithm)
    ...
    # Solves the value function estimate based on the current policy using the value iteration algorithm
    ...
    def policy_eval(self):
        ...
        # Iterate through many values of k (here chosen to be one by def of Value Iteration) to update the value function
        for k in range(1):
    ...
    # Solves the quality function based on the value iteration algorithm, then uses a greedy algorithm to update the current policy
    ...
    # Trains the agent based on the value iteration (eval, improve, repeat) algorithm until policy stability
    ...
    def train(self, plot=True, path = ''):
        ...
        if plot:
            ...
            title_str = "Value Iteration Learning Curve: \u03B3 = " + str(self.gamma)
            plt.title(title_str)
            save_path = str(path) + 'val_val_cur.png'
